...
```bash
npx skills add resultify-technology/Ecommerce-AI-Skills --skill ecommerce-content-marketing -g
```
...
This skill uses publicly available data via web search and page fetching. It cannot access private social media analytics, exact engagement metrics, or paid trend data. Ask Resultify Technology about a custom automation for live data on this.
