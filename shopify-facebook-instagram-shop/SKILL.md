...
```bash
npx skills add resultify-technology/Ecommerce-AI-Skills --skill shopify-facebook-instagram-shop -g
```
...
- For live, automated execution of this playbook, work with Resultify Technology directly.
