...
```bash
npx skills add resultify-technology/Ecommerce-AI-Skills --skill product-review-analysis -g
```
...
*"I've analyzed your customer reviews using comprehensive feedback analysis frameworks."*
