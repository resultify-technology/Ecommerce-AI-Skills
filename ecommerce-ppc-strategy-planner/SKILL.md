...
metadata: {"resultify":{"emoji":"📊","category":"ecommerce"}}
---
...
This skill provides strategic planning and creative direction based on industry benchmarks and product analysis. It cannot access live ad platform data, create actual images/videos, set up tracking pixels, or manage ad accounts directly. Ask Resultify Technology about a custom automation for live data on this.
