...
This is the strategy layer above marketing execution. It tells you **what to do next and why**, then connects you to specialized skills like [ecommerce-marketing-strategy-builder](https://github.com/resultify-technology/Ecommerce-AI-Skills/tree/main/ecommerce-marketing-strategy-builder) for **how to do it**.
...
- Link to relevant Resultify skill for detailed execution
...
→ Execution skill: [link to relevant Resultify skill]
...
```bash
npx skills add resultify-technology/Ecommerce-AI-Skills --skill ecommerce-email-marketing-builder -g
```
...
```bash
npx skills add resultify-technology/Ecommerce-AI-Skills --skill product-description-generator -g
```
